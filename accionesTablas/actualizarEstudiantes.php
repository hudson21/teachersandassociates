...
<center>
<form action="actualizarE.php" method="POST" class="form-insertar">

    <h2 class="form-titulo">ACTUALIZAR</h2>           
  <div class="contenedor-inputs">
  <input type="text" name="id_estudiante" placeholder="id_estudiante" class="input-48" required>
  ...
  <input type="text" name="semestre" placeholder="semestre" class="input-48" required>
  <input type="text" name="turno" placeholder="turno" class="input-48" required><br>
  <input type="submit" value="actualizar"  >  <p></p>
